...
//
//        return false;
        return Main.getNMSHook().isSpawnEgg(itemStack);
    }
...
//
//        return null;
        return Main.getNMSHook().spawnEntityFromNBTData(spawnItem, target);
    }
...
//
//        return itemStack;
        return Main.getNMSHook().castEntityDataToItemStackNBT(itemStack, livingEntity);
    }

    public static List<String> createItemLore(final LivingEntity livingEntity) {
...
//        return Main.getNMSHook().generateNBTTagCompound()
//    }
